...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine($"Result {Base64Utils.FromBase64("")}");
        Console.WriteLine($"Result {Base64Utils.ToBase64("this is a string!!")}");
        Console.WriteLine($"Result {Base64Utils.ToBase64("e")}");
        Console.WriteLine($"Result {Base64Utils.ToBase64("ee")}");
        Console.ReadLine();
    }
